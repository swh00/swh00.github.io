...
| 백준 확장프로그램 | 자동 생성된 노트(Issue) |
| :---: | :---: |
| ![백준 확장프로그램](/assets/img/2025post/2025-12-30-setup-boj-extension/2025-12-30-boj-extension.jpg) | ![자동 생성된 노트](/assets/img/2025post/2025-12-30-setup-boj-extension/2025-12-30-boj-issue-note.jpg) |
...
def create_issue(pid, file_path, data):
    ...
    issue_body = textwrap.dedent(f"""\
        ...
        ## 1. 문제 파악
        > 문제를 처음 보았을 때의 생각과 핵심 포인트를 적어보세요.

        - 

        ## 2. 접근 방법
        > 어떻게 풀 것인지 고민한 과정을 적어보세요.

        1. 
        2. 

        ## 3. 코드 구현 시 주의점
        > 코드를 짤 때 실수하기 쉬운 부분이나 트릭을 적어보세요.

        - 

        ## 4. 배우고 느낀 점
        > 문제를 풀며 알게 된 새로운 사실이나 반성할 점을 적어보세요.
